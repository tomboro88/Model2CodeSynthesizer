...
extern "C" {
    ...
    typedef enum {
        ...
        SM_EVENT_STATUS_PENDING      = 1u, /**< Event waiting for processing.*/
        SM_EVENT_STATUS_IGNORED      = 2u, /**< Event ignored.*/
        SM_EVENT_STATUS_DEFERRED     = 3u, /**< Event deferred.*/
        SM_EVENT_STATUS_SAMESTATE    = 4u, /**< Event handled,
                                                              no state change.*/
        SM_EVENT_STATUS_CHANGEDSTATE = 5u, /**< Event handled, state changed.*/
        SM_EVENT_STATUS_DISPATCHED   = 6u /**< Event processed and removed from
                                               the event pool.*/
    }sm_event_status_t;
