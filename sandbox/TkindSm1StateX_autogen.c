...
TEST(TkindSm1State4, FetchOReturnsTrue)
{
    tkind_ctest_logger_expect(true, NULL);
    tkind_ctest_logger_given(Tkind_ctest_o(&tkind_ctest_obj)
                       && Tkind_ctest_fetch_event(&tkind_ctest_obj));
...
TEST(TkindSm1State4, DispatchOReturnsTrue)
{
    tkind_ctest_logger_expect(true, NULL); 
    tkind_ctest_logger_given(Tkind_ctest_o(&tkind_ctest_obj)
                       && Tkind_ctest_fetch_event(&tkind_ctest_obj)
...
TEST(TkindSm1State4, ReleaseOReturnsTrue)
{
    tkind_ctest_logger_expect(true, NULL);
    tkind_ctest_logger_given(Tkind_ctest_o(&tkind_ctest_obj)
                       && Tkind_ctest_fetch_event(&tkind_ctest_obj)
...
TEST_GROUP_RUNNER(TkindSm1State4)
{
    ...
    RUN_TEST_CASE(TkindSm1State4, FetchOReturnsTrue);
    RUN_TEST_CASE(TkindSm1State4, DispatchOReturnsTrue);
    RUN_TEST_CASE(TkindSm1State4, ReleaseOReturnsTrue);
